const promptUser = require("readline-sync");
...
const npc = {
  grunt: {
    ...
    takeTurn: function () {
      ...
      console.log(
        `***The grunt fires a round with a plasma pistol***\n***You take ${dmg} damage***`
      );
    },
    reset: function () {
  ...
  brute: {
    ...
    takeTurn: function () {
      ...
      if (this.health < this.maxHP / 2) {
        ...
        player.health = player.health - dmg;
        console.log(
          "***The brute screams and charges at you with its bear hands***"
        );
  ...
  hunter: {
    ...
    takeTurn: function () {
      ...
      if (this.health < this.maxHP / 2) {
        ...
        player.health = player.health - dmg;
        console.log(
          "***The hunter barrels towards you and swings its shelid at you***"
        );
        console.log(`***You take ${dmg} damage***`);
      } else {
        dmg = this.damageGun();
...
const player = {
  ...
  damageVerbal: function (enemy) {
    if (enemy.name === "grunt") {
      ...
      console.log(
        `***You yell that the brute isn't as cool as he thinks he is***`
      );
      console.log(
  ...
  printStats: function () {
    ...
    console.log(
      `HP: ${this.health} | Grenades: ${this.grenades} | Health Packs: ${this.healthPacks}`
    );
    console.log("-".repeat(40));
  },
...
while (stillPlaying) {
  switch (phase) {
    ...
    default:
      let ask = true;
      while (ask) {
        let input = promptUser.keyInYN("Do you want to stop playing?");
        if (input === "") {
...
function level(enemy) {
  ...
  while (!quitGame) {
    ...
    let option = promptUser.questionInt(
    ...
    switch (option) {
      ...
      case 1:
        ...
        console.log(
          `***You shoot at the ${enemy.name} with your assault rifle***`
        );
    ...
    if (player.health <= 0) {
      console.log(
        `***You died, I guess you don't have what it takes to be an ODST***`
      );
      printLevel(4);
...
function printLevel(level) {
  switch (level) {
    case 1:
      ...
      console.log(
        "***You look around and see a grunt taking a nap next to a tree***"
      );
      break;
    case 2:
      console.log(`
      ...
      console.log(
        "***You make your way down the street slowly ducking bewteen covers making your way to the objective***"
      );
      console.log(
        "***You see a brute standing outside the entrance of the last know location of the politician***"
      );
      break;
    case 3:
      console.log(`            
    ...
    default:
      console.log(
        "***You search the building and find the politician in his office hiding under his desk***"
      );
      console.log(
        "***You and the politician escape and make it back to base***"
      );
      console.log(` 
                +-+-+-+-+-+-+-+ +-+-+-+-+-+-+-+-+-+
